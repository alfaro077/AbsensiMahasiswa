...
<body class="bg-slate-50 text-slate-800 antialiased min-h-screen flex flex-col hidden" id="app-body">
    ...
    <!-- Top Navigation Bar -->
    <nav class="bg-indigo-600 text-white shadow-lg sticky top-0 z-30">
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <button onclick="logout()" class="hidden sm:flex text-sm bg-indigo-700 hover:bg-red-500 px-4 py-2 rounded-lg font-semibold transition-all duration-300 shadow-sm items-center gap-2">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <div id="sidebar-backdrop" class="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-40 hidden transition-opacity duration-300 md:hidden"></div>

        <!-- Sidebar -->
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-white shadow-2xl transform -translate-x-full transition-transform duration-300 ease-in-out flex flex-col md:z-20">
            <!-- Sidebar Header -->
            ...
            <div class="p-4 border-t border-slate-700/50">
                <button onclick="logout()" class="w-full flex items-center justify-center gap-2 p-3 rounded-xl bg-red-500/10 hover:bg-red-500 text-red-300 hover:text-white font-bold transition-all text-sm border border-red-500/20 hover:border-red-400">
